...
// GPSの設定
TinyGPSPlus gps;
const double Kp_gps = 0.3; // P制御の比例ゲイン
const double goal_location[2] = {35.9183162, 139.9082445};// ゴール座標

// カメラの設定
const double Kp_camera = 0.03; // P制御の比例ゲイン
const int pix = 320; //画素数

// SDカードの設定
File file;
const String FILE_NAME = "gps_camera"; // ファイル名
...
void CreateFile(String FILE_NAME) {
  ...
  Serial.println("Creating file: " + file_name);
}
