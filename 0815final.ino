...
// GPSの設定
TinyGPSPlus gps;
const double Kp_gps = 1.0; // P制御の比例ゲイン
const double goal_location[2] = {40.1422826459, 139.9873883750};// ゴール座標
...
// SDカードの設定
File file;
const String FILE_NAME = "0815final"; // ファイル名
