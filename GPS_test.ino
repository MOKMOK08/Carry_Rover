...
// GPSの設定
TinyGPSPlus gps;
const double goalGPSdata2[2] = {35.9183288, 139.9078658};// 早川の家
...
void P_GPS_Moter() { 
  ...
  while(1){
    ...
    if(azidata[1] < 5){
      ...
      int PID_left = constrain(Kp * azidata[0] + 206, 0, 255); // 0.65は車輪半径
      int PID_right = constrain(- Kp * azidata[0] + 206, 0, 255);
